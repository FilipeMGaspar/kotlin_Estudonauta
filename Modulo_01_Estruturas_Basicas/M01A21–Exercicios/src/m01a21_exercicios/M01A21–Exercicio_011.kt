...
fun main(args: Array<String>) {
    ...
    println("${AMARELO}Esse mês no${RESET}${AZUL}${((dataAtual.monthValue - 1) / 6) + 1}º semestre${RESET}")
    println("${ AMARELO}E está no${RESET}${AZUL}${((dataAtual.monthValue - 1) / 3) + 1}º trimestre${RESET}")
